...
namespace bb
{
	...
	public:
		...
		static const KeySetting& getRotateLeftKey() { return *instance->mRotateLeftKey; }
		static const KeySetting& getRotateRightKey() { return *instance->mRotateRightKey; }
	...
	private:
		...
		KeySetting *mRotateLeftKey;
		KeySetting *mRotateRightKey;
